...
import { EnvironnementSecurite } from './pates-papiers';
...
const CalculateurPatesPapiers = () => {
  ...
  const {
    ...
    coutSysteme, coutInstallation, coutIngenierie, coutFormation, coutMaintenance,
    coutEnergie, dureeVie, nbEmployesRemplaces, subventions, reductionEmpreinteCO2
  } = parametresSystemeAutomatise;
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow-lg max-w-6xl mx-auto">
      ...
      {ongletActif === 'securite' && (
        <EnvironnementSecurite 
          frequenceAccidentActuel={frequenceAccidentActuel} 
          coutMoyenAccident={coutMoyenAccident}
          reductionAccidents={reductionAccidents}
          economiesSecurite={economiesSecurite}
          economiesTempsArret={economiesTempsArret}
          reductionEmpreinteCO2={reductionEmpreinteCO2}
          economiesCO2={economiesCO2}
          dureeVie={dureeVie}
        />
      )}
    </div>
