...
/**
 * Section des résultats pour le calculateur pâtes et papiers
 */
const ResultatsSection = () => {
  ...
  const {
    capacite: capaciteActuelle, tauxRejets: tauxRejetsManuel,
    frequenceAccident: frequenceAccidentActuel, coutMoyenAccident
  } = parametresSystemeActuel;
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center">
            ...
            <span>Réduction de la main d'œuvre de <strong>{formatMoney(reductionMainOeuvre)}/an</strong></span>
          </div>
          <div className="flex items-center">
            <svg className="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
        ...
        <div className="mt-2 p-2 bg-white rounded border border-blue-100">
          ...
          <p className="text-sm">
            Économie annuelle estimée: <span className="font-bold">
              {formatMoney(economiesSecurite + economiesTempsArret)}
            </span>
          </p>
        </div>
      </div>
