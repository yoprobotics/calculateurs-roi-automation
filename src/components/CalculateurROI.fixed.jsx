              ...
              <tbody>
                ...
                <tr className="border-t">
                  ...
                  <td className="px-4 py-2 text-right">
                    {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(coutSysteme + coutInstallation + coutIngenierie + coutFormation - subventions)}
                  </td>
                  <td className="px-4 py-2 text-right">{roi.toFixed(2)}%</td>
                  <td className="px-4 py-2 text-right">{delaiRecuperation.toFixed(2)} ans</td>
                  <td className="px-4 py-2 text-right">
                    {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(van)}
                  </td>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {erreurs.coutSysteme && <p className="text-red-500 text-xs mt-1">{erreurs.coutSysteme}</p>}
                <p className="text-xs text-gray-500 mt-1">Prix d'achat de l'équipement d'automatisation, incluant tous les composants matériels du système.</p>
              </div>
              <div>
                ...
                />
                {erreurs.coutInstallation && <p className="text-red-500 text-xs mt-1">{erreurs.coutInstallation}</p>}
                <p className="text-xs text-gray-500 mt-1">Coûts liés à l'installation physique, au câblage et à l'intégration dans l'environnement existant.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {erreurs.coutMainOeuvre && <p className="text-red-500 text-xs mt-1">{erreurs.coutMainOeuvre}</p>}
                <p className="text-xs text-gray-500 mt-1">Salaire annuel complet incluant charges sociales, avantages et coûts indirects.</p>
              </div>
              <div>
                ...
                />
                {erreurs.nombreEmployesActuel && <p className="text-red-500 text-xs mt-1">{erreurs.nombreEmployesActuel}</p>}
                <p className="text-xs text-gray-500 mt-1">Nombre total d'employés actuellement.</p>
              </div>
              <div>
                ...
                />
                {erreurs.nbEmployesRemplaces && <p className="text-red-500 text-xs mt-1">{erreurs.nbEmployesRemplaces}</p>}
                <p className="text-xs text-gray-500 mt-1">Équivalent temps plein (ETP) d'employés dont le travail est automatisé (ex: 1.5 = un temps plein et un mi-temps).</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {erreurs.dureeVie && <p className="text-red-500 text-xs mt-1">{erreurs.dureeVie}</p>}
                <p className="text-xs text-gray-500 mt-1">Durée d'utilisation prévue avant remplacement ou mise à niveau majeure.</p>
              </div>
              <div>
                ...
                />
                {erreurs.tauxActualisation && <p className="text-red-500 text-xs mt-1">{erreurs.tauxActualisation}</p>}
                <p className="text-xs text-gray-500 mt-1">Taux utilisé pour calculer la valeur actuelle des flux futurs (souvent le coût du capital).</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-blue-50 p-3 rounded">
                ...
                <p className="text-xs text-gray-600 mt-1">Pourcentage de retour sur l'investissement total sur la durée de vie du système</p>
              </div>
              <div className="bg-green-50 p-3 rounded">
                ...
                <p className="text-xs text-gray-600 mt-1">Temps nécessaire pour que les bénéfices cumulés égalent l'investissement initial</p>
              </div>
              <div className="bg-purple-50 p-3 rounded">
                ...
                <p className="text-xs text-gray-600 mt-1">Valeur Actuelle Nette - valeur actualisée des flux futurs moins l'investissement initial</p>
              </div>
              <div className="bg-indigo-50 p-3 rounded">
                ...
                <p className="text-xs text-gray-600 mt-1">Taux de Rendement Interne - taux d'actualisation qui annule la VAN</p>
              </div>
            </div>
