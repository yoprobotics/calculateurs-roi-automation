...
/**
 * Section des détails financiers du calculateur
...
const DetailsFinanciersSection = ({ chartData }) => {
  ...
  const { 
    ...
    coutLogiciel, subventions, dureeVie
  } = parametresSystemeAutomatise;
  
  const { 
    roi, delaiRecuperation, van, tri, resultatAnnuel 
  } = resultats;
  ...
  return (
    <div className="grid grid-cols-1 gap-8">
      <div className="bg-white p-4 rounded-lg shadow">
        <h2 className="text-xl font-semibold mb-4 text-blue-700">Analyse financière détaillée</h2>
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
        <h3 className="font-medium text-blue-800 mb-2">Guide d'interprétation des indicateurs financiers</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-1">ROI (Retour sur Investissement)</h4>
            <p className="text-sm mb-2">Mesure la rentabilité globale de l'investissement.</p>
          ...
          <div>
            ...
            <p className="text-sm mb-2">Temps nécessaire pour récupérer l'investissement initial.</p>
            <ul className="list-disc pl-5 text-xs space-y-1 text-gray-600">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 text-xs space-y-1 text-gray-600">
              ...
              <li>Une VAN élevée indique un fort potentiel de création de valeur.</li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-sm font-semibold text-gray-700 mb-1">TRI (Taux de Rendement Interne)</h4>
            <p className="text-sm mb-2">Taux de rentabilité annualisé de l'investissement.</p>
            <ul className="list-disc pl-5 text-xs space-y-1 text-gray-600">
              <li><span className="font-medium">TRI > taux d'actualisation</span> : L'investissement est rentable.</li>
              <li><span className="font-medium">TRI > 20%</span> : Excellent rendement.</li>
              <li><span className="font-medium">TRI entre 10% et 20%</span> : Bon rendement.</li>
            </ul>
          </div>
        </div>
      </div>
